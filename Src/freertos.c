...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(HolderTask, HolderTask_Function, osPriorityLow, 0, 512);
...
/* USER CODE BEGIN Header_HolderTaskTask_Function */
/**
* @brief Function implementing the HolderTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_HolderTaskTask_Function */
__weak void HolderTaskTask_Function(void const * argument)
{
  /* USER CODE BEGIN HolderTaskTask_Function */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END HolderTaskTask_Function */
}
