...
kalman_type       kalman_x     = {.Q_angle = 0.25, .Q_gyro = 0.003, .dt = 0.005, .C_0 = 1, .PP[0][0] = 1, .PP[0][1] = 0, .PP[1][0] = 0, .PP[1][1] = 1, .R_angle = 0.03};
kalman_type       kalman_y     = {.Q_angle = 0.25, .Q_gyro = 0.003, .dt = 0.005, .C_0 = 1, .PP[0][0] = 1, .PP[0][1] = 0, .PP[1][0] = 0, .PP[1][1] = 1, .R_angle = 0.03};
kalman_type       kalman_z     = {.Q_angle = 0.25, .Q_gyro = 0.003, .dt = 0.005, .C_0 = 1, .R_angle = 0.11, .PP[0][0] = 1, .PP[0][1] = 0, .PP[1][0] = 0, .PP[1][1] = 1};
kalman_speed_type kalman_speed = {.Q_speed = 0.0002, .dt = 0.02, .C_0 = 1, .R_speed = 0.9f, .PP[0][0] = 1, .PP[0][1] = 0, .PP[1][0] = 0, .PP[1][1] = 1};
