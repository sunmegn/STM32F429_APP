...
/*定义默认IP信息*/
uint8 local_ip[4]  ={192,168,1,10};										/*定义W5500默认IP地址*/
...
/*定义远端IP信息*/
uint8  remote_ip[4]={192,168,1,255};			  						/*远端IP地址*/
...
void wiz_cs(uint8_t val)
{
	if (val == LOW) 
	{
	  HAL_GPIO_WritePin(W5500_SPI_CS_GPIO_Port, W5500_SPI_CS_Pin, GPIO_PIN_RESET);
	}
	else if (val == HIGH)
	{
	  HAL_GPIO_WritePin(W5500_SPI_CS_GPIO_Port, W5500_SPI_CS_Pin, GPIO_PIN_SET);
	}
}
